"""
Code adapted from the PyTorch torchvision resnet code:
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, widths=[64, 128, 256, 512], feature_dim=512, num_classes=1000, projection=False, zero_init_residual=False, drop_rate=0, use_fc=False):
